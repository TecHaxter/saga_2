...
?>
        ...
        <!-- Begin Munoz's Page Content Area -->
        <main class="page-content">
            <!-- Begin Munoz's Account Page Area -->
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <ul class="nav myaccount-tab-trigger" id="account-page-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="account-logout-tab" href="/logout-user" role="tab" aria-selected="false">Logout</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-9">
                            <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                                            ...
                                            <table class="table table-bordered table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript:void(0)" class="munoz-btn munoz-btn_dark munoz-btn_sm"><span>View</span></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                ...
                                <div class="tab-pane fade" id="account-details" role="tabpanel" aria-labelledby="account-details-tab">
                                    <div class="myaccount-details">
                                        <form action="#" class="munoz-form">
                                            <div class="munoz-form-inner">
                                                ...
                                                <div class="single-input">
                                                    <button class="munoz-btn munoz-btn_dark" type="submit"><span>Save
                                                    Changes</span></button>
                                                </div>
                                            </div>
                                        </form>
            ...
            <!-- Munoz's Account Page Area End Here -->
        </main>
        <!-- Munoz's Page Content Area End Here -->
